...
<head>
  ...
  <meta name="description" content="EXIMIUS Alumni — the range of roles they undertake reflects their abilities and the opportunities across EDGE Group operations." />
  <title>EXIMIUS Alumni</title>
...
<body>
  ...
  <main id="main-content">
    ...
    <section class="people" aria-labelledby="alumni-title">
      <div class="container">
        <h2 class="visually-hidden" id="alumni-title">EXIMIUS Alumni</h2>
            ...
            <article class="person-card revealme">
              <div class="person-card__media">
                <img src="assets/images/<?= htmlspecialchars($img, ENT_QUOTES, 'UTF-8'); ?>"
                  alt="EXIMIUS alumnus" loading="lazy" />
              </div>
              <div class="person-card__info">
                <div class="person-card__heading">
                  <p class="person-card__role">EDGE FTE role</p>
                  <p class="person-card__name">Name of the specialist</p>
                </div>
                <p class="person-card__meta">Graduating at 2027</p>
              </div>
            </article>
          <?php endforeach; ?>
        </div>
